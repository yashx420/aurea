        ...
        >
          <div className={styles.bookingCard}>
            ...
            <div className={styles.giftTypeSelector}>
              <button
                className={giftType === "digital" ? styles.activeSelector : ""}
                onClick={() => setGiftType("digital")}
              >
                E-Voucher
              </button>
              <button
                className={giftType === "physical" ? styles.activeSelector : ""}
                onClick={() => setGiftType("physical")}
              >
                Physical Pack
              </button>
            ...
            <button className={styles.primaryAction} onClick={handleAddToCart}>
              {addedToCart ? (
                <>
